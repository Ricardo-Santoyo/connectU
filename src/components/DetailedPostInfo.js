...
function DetailedPostInfo(props) {
  ...
  return (
    <div id="ShowPost">
      ...
      <PostOptions data={props.data} likeCall={props.likeCall} repostCall={props.repostCall} bookmarkCall={props.bookmarkCall} updateCommentInfo={props.updateCommentInfo}/>
    </div>
  );
}
